...
function TransportadorasView() {
  ...
  const handleSubmitCadastro = async (e) => {
    ...
    // Validações
    if (!formData.poderesAssinatura) {
      alert('O representante legal deve ter poderes para assinatura de contratos.')
      return
    }
    
    if (!formData.emailRepresentante.includes('@')) {
      alert('Email do representante legal é obrigatório e deve ser válido.')
      return
    }
    ...
    try {
      ...
      alert('Transportadora cadastrada com sucesso! Um email será enviado ao representante legal.')
      setMostrarFormulario(false)
      setFormData({
        razaoSocial: '', cnpj: '', inscricaoEstadual: '', endereco: '', cidade: '', estado: '', cep: '', telefone: '',
        nomeRepresentante: '', cpfRepresentante: '', emailRepresentante: '', telefoneRepresentante: '', cargoRepresentante: '', poderesAssinatura: false,
        rgRepresentante: '', comprovanteEndereco: '', procuracao: ''
      })
    } catch (error) {
      ...
      {mostrarFormulario && (
        <div className="modal-overlay" onClick={() => setMostrarFormulario(false)}>
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
            ...
            <form onSubmit={handleSubmitCadastro} className="form-cadastro-transportadora">
              {/* Dados da Transportadora */}
                ...
                <div className="form-grid">
                  <div className="form-group">
                    ...
                    <input
                      ...
                      required
                      placeholder="Ex: Silva Transportes Ltda"
                    />
                  </div>
                  <div className="form-group">
                    <label>CNPJ *</label>
              ...
              <div className="secao-formulario">
                ...
                <div className="alert-info">
                  <strong>Importante:</strong> O representante legal deve ter poderes para assinatura de contratos. 
                  O email informado será usado para envio do link de assinatura.
                </div>
                <div className="form-grid">
                  <div className="form-group full-width">
                  ...
                  <div className="form-group full-width">
                    ...
                    />
                    <small>Este email será usado para envio do link de assinatura do contrato</small>
                  </div>
                  <div className="form-group">
                ...
                <div className="form-group checkbox-importante">
                  <label className="checkbox-label">
                    <input
                      type="checkbox"
                      name="poderesAssinatura"
                      checked={formData.poderesAssinatura}
                      onChange={handleInputChange}
                      required
                    />
                    <span className="checkmark"></span>
                    Confirmo que o representante legal informado possui poderes para assinatura de contratos *
                  </label>
                </div>
              </div>
              ...
              <div className="secao-formulario">
                <h4>📄 Documentos do Representante</h4>
                <div className="alert-warning">
                  <strong>Atenção:</strong> Os documentos abaixo serão solicitados após o cadastro inicial.
                </div>
                <div className="documentos-lista">
                  <div className="documento-item">
                    <span className="doc-icon">📋</span>
                    <span className="doc-nome">RG ou CNH do Representante Legal</span>
                    <span className="doc-status">Pendente</span>
                  </div>
                  <div className="documento-item">
                    <span className="doc-icon">🏠</span>
                    <span className="doc-nome">Comprovante de Endereço (até 6 meses)</span>
                    <span className="doc-status">Pendente</span>
                  </div>
                  <div className="documento-item">
                    <span className="doc-icon">📜</span>
                    <span className="doc-nome">Procuração (se aplicável)</span>
                    <span className="doc-status">Opcional</span>
                  </div>
                  <div className="documento-item">
                    <span className="doc-icon">🏢</span>
                    <span className="doc-nome">Contrato Social da Empresa</span>
                    <span className="doc-status">Pendente</span>
                  </div>
                </div>
              </div>
              ...
              <div className="form-actions">
                ...
                <button 
                  ...
                  disabled={!formData.poderesAssinatura}
                >
